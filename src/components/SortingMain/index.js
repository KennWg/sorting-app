...
import {mergeSortAnimations, heapSortAnimations, quickSortAnimations, bubbleSortAnimations} from "../../algorithms";
...
function SortingMain() {
    ...
    //Bubble sort
    const bubbleSort = () => {
        const animations = bubbleSortAnimations(state);
    ...
    return (
        <div className="w-100 justify-content-center">
            <h1 className="text-center my-3">Sorting Visualizer</h1>
            <div className="row w-100 pb-4 justify-content-center">
                ...
                <button className="col-2 btn btn-info mx-1" onClick={bubbleSort}>Bubble Sort</button>
            </div>
